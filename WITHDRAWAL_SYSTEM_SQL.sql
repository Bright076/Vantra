...
-- ============================================
-- DONE! 
-- The withdrawal page will now work.
-- To add winners, run something like:
-- 
-- INSERT INTO withdrawal_winners (round_id, user_id, rank, balance_at_selection, status, ineligibility_reason)
-- VALUES 
--   ('round-uuid', 'user1-uuid', 1, 150.00, 'pending', NULL),
--   ('round-uuid', 'user2-uuid', 2, 120.50, 'pending', NULL),
--   ('round-uuid', 'user3-uuid', 3, 90.00, 'ineligible', 'Balance under $100');
-- ============================================
